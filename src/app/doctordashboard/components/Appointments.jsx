...
const Appointment = () => {
  ...
  return (
    <div className="w-full md:w-[40vw] xl:w-[35vw] bg-white h-[45vh] flex flex-col gap-1 rounded-2xl p-4">
      <div className="flex gap-3">
        <button onClick={()=>{
          setActive(false)
        }} className={`${active===false && "border-b border-[#205454]"} cursor-pointer pb-2 heading italic font-[500]`}>New Appointments</button>
        <button 
        onClick={()=>{
          setActive(true)
        }}
         className={`${active===true && "border-b-1 border-[#205454]"} cursor-pointer pb-2 heading italic font-[500]`}>Pending Appointments</button>
      </div>
