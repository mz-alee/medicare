    ...
    <div className="w-full md:w-[35vw] xl:w-[17vw] bg-white h-[45vh] flex flex-col gap-1 rounded-2xl p-4">
      ...
      <div className=" h-60  flex flex-col justify-center gap-4  xl:h-[40vh]">
        ...
        <div className='flex items-center gap-2'>
          ...
          <p className='capitalize text-[10px] xl:text-[0.7vw]'>completed appoitments</p>
        </div>
        <div className='flex items-center gap-2'>
          <span className='w-2 h-2 rounded-full bg-purple-400 block'></span>
          <p className='capitalize text-[10px] xl:text-[0.7vw]'>recoverd patient</p>
        </div>
        <div className='flex items-center gap-2'>
          <span className='w-2 h-2 rounded-full bg-green-400 block'></span>
          <p className='capitalize text-[10px] xl:text-[0.7vw]'>upcoming Appointments</p>
        </div>
        <div className='flex items-center gap-2'>
          <span className='w-2 h-2 rounded-full bg-yellow-400 block'></span>
          <p className='capitalize text-[10px] xl:text-[0.7vw]'>pending Appointments</p>
        </div>
        </div>
        <ChartComponent/>
      </div>
