...
const Services = () => {
  return (
    <div className="bg-[#f4f4f4] w-full flex gap-4 py-4  justify-around flex-col md:flex-row  items-center  mt-10 min-h-[70vh]">
      <div className="bg-[#d8edd0] md:w-[25vw] h-[55vh] rounded-2xl">
        <Image
          src={docter}
          alt="docter"
      ...
      <div className="flex flex-col items-center  md:w-130 gap-8 ">
        ...
        <h2 className="text-[15px] italic  md:text-[1.5vw] text-center  ">
        ...
        <div className=' flex flex-wrap  justify-center gap-3 md:justify-between'>
          ...
          <div className="flex gap-2 w-60 ">
            <div className="flex  ">
              <Image src={heartIcon} className="w-10 h-10" alt="heart"></Image>
            </div>
            <div>
          ...
          <div className="flex gap-2 w-60">
            <div className="flex  ">
              <Image src={lightIcon} className="w-10 h-10" alt="heart"></Image>
            </div>
            <div>
